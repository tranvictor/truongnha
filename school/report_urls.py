...
urlpatterns = patterns('',
    ...
    url(r'practisingByGrade/(?P<yearNumber>\w+)/(?P<termNumber>\w+)$', departmentReport.practisingByGrade,
        name="practising_by_grade"),
    url(r'practisingByGrade/(?P<yearNumber>\w+)/(?P<termNumber>\w+)/(?P<isExcel>\w+)$',
        departmentReport.practisingByGrade, name="practising_by_grade"),
    ...
    url(r'practisingByMajor/(?P<yearNumber>\w+)/(?P<termNumber>\w+)$', departmentReport.practisingByMajor,
        name="practising_by_major"),
    url(r'practisingByMajor/(?P<yearNumber>\w+)/(?P<termNumber>\w+)/(?P<isExcel>\w+)$',
        departmentReport.practisingByMajor, name="practising_by_major"),

    url(r'practisingByDistrict$', departmentReport.practisingByDistrict, name="practising_by_district"),
    url(r'practisingByDistrict/(?P<yearNumber>\w+)$', departmentReport.practisingByDistrict,
        name="practising_by_district"),
    url(r'practisingByDistrict/(?P<yearNumber>\w+)/(?P<termNumber>\w+)$', departmentReport.practisingByDistrict,
        name="practising_by_district"),
    url(r'practisingByDistrict/(?P<yearNumber>\w+)/(?P<termNumber>\w+)/(?P<isExcel>\w+)$',
        departmentReport.practisingByDistrict, name="practising_by_district"),
    ...
    url(r'learningByGrade/(?P<yearNumber>\w+)/(?P<termNumber>\w+)$', departmentReport.learningByGrade,
        name="learning_by_grade"),
    url(r'learningByGrade/(?P<yearNumber>\w+)/(?P<termNumber>\w+)/(?P<isExcel>\w+)$', departmentReport.learningByGrade,
        name="learning_by_grade"),
    ...
    url(r'learningByMajor/(?P<yearNumber>\w+)/(?P<termNumber>\w+)$', departmentReport.learningByMajor,
        name="learning_by_major"),
    url(r'learningByMajor/(?P<yearNumber>\w+)/(?P<termNumber>\w+)/(?P<isExcel>\w+)$', departmentReport.learningByMajor,
        name="learning_by_major"),
    ...
    url(r'learningByDistrict/(?P<yearNumber>\w+)/(?P<termNumber>\w+)$', departmentReport.learningByDistrict,
        name="learning_by_district"),
    url(r'learningByDistrict/(?P<yearNumber>\w+)/(?P<termNumber>\w+)/(?P<isExcel>\w+)$',
        departmentReport.learningByDistrict, name="learning_by_district"),
    ...
    url(r'titleByGrade/(?P<yearNumber>\w+)/(?P<termNumber>\w+)/(?P<isExcel>\w+)$', departmentReport.titleByGrade,
        name="title_by_grade"),
    ...
    url(r'titleByMajor/(?P<yearNumber>\w+)/(?P<termNumber>\w+)/(?P<isExcel>\w+)$', departmentReport.titleByMajor,
        name="title_by_major"),
    ...
    url(r'titleByDistrict/(?P<yearNumber>\w+)/(?P<termNumber>\w+)$', departmentReport.titleByDistrict,
        name="title_by_district"),
    url(r'titleByDistrict/(?P<yearNumber>\w+)/(?P<termNumber>\w+)/(?P<isExcel>\w+)$', departmentReport.titleByDistrict,
        name="title_by_district"),
    ...
    url(r'countFinalMark/(?P<type>\w+)/(?P<yearNumber>\w+)/(?P<termNumber>\w+)$', departmentReport.countFinalMark,
        name="count_final_mark"),
    url(r'countFinalMark/(?P<type>\w+)/(?P<yearNumber>\w+)/(?P<termNumber>\w+)/(?P<subjectIndex>\w+)$',
        departmentReport.countFinalMark, name="count_final_mark"),
    url(
        r'countFinalMark/(?P<type>\w+)/(?P<yearNumber>\w+)/(?P<termNumber>\w+)/(?P<subjectIndex>\w+)/(?P<blockIndex>\w+)$'
        , departmentReport.countFinalMark, name="count_final_mark"),
    url(
        r'countFinalMark/(?P<type>\w+)/(?P<yearNumber>\w+)/(?P<termNumber>\w+)/(?P<subjectIndex>\w+)/(?P<blockIndex>\w+)/(?P<isExcel>\w+)$'
        , departmentReport.countFinalMark, name="count_final_mark"),
    ...
    url(r'count2/(?P<type>\w+)/(?P<modeView>\w+)/(?P<year_id>\w+)/(?P<number>\w+)/(?P<index>\w+)$', viewCount.count2,
        name="count2"),
    url(r'count2/(?P<type>\w+)/(?P<modeView>\w+)/(?P<year_id>\w+)/(?P<number>\w+)/(?P<index>\w+)/(?P<isExcel>\w+)$',
    ...
    url(r'printMarkForClass/(?P<termNumber>\w+)/(?P<class_id>\w+)$', writeExcel.printMarkForClass,
        name="print_mark_for_class"),
    url(r'markExcelForAStudent/(?P<class_id>\w+)/(?P<student_id>\w+)/(?P<term_id>\w+)$', writeExcel.markExcelForAStudent
        , name="mark_excel_for_a_student"),

    url(r'printDanhHieu$', viewCount.printDanhHieu, name="print_danh_hieu"),
    url(r'printDanhHieu/(?P<year_id>\w+)/(?P<term_number>\w+)/(?P<type>\w+)$', viewCount.printDanhHieu,
        name="print_danh_hieu"),
    url(r'printDanhHieu/(?P<year_id>\w+)/(?P<term_number>\w+)/(?P<type>\w+)/(?P<isExcel>\w+)$', viewCount.printDanhHieu,
        name="print_danh_hieu"),
    ...
    url(r'histotyMark/(?P<term_id>\w+)$', viewCount.history_mark, name="history_mark"),
