...
urlpatterns = patterns('',
     ...
     url(r'manage_agenda/(?P<subject>\d+)/(?P<grade>\d+)/(?P<term>\d+)$', system_subject_agenda, name="system_subject_agenda"),
     url(r'manage_agenda/$', system_subject_agenda, name="system_subject_agenda"),
     url(r'import/systemAgenda/(?P<subject>\d+)/(?P<grade>\d+)/(?P<term>\d+)$', import_system_agenda, name="import_system_agenda"),
     url(r'export_system_agenda/(?P<subject>\d+)/(?P<grade>\d+)/(?P<term>\d+)$', export_system_agenda, name="export_system_agenda"),
